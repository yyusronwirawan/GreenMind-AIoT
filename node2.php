...
<script>
  function sendData(switchId, value) {
    fetch('backend/node2/update_switch2.php', {
        method: 'POST',
        headers: {
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('backend/node2/load_switch2.php')
      .then(response => {
        if (!response.ok) {
...
<!--  -->
<script src="./backend/node2/data2.js"></script>
<script src="./backend/node2/grafik2.js"></script>
