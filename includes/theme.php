<footer class="content-footer footer bg-footer-theme text-center">
    <div class="container-xxl">
        <div class="footer-container d-flex align-items-center justify-content-center py-4 flex-column">
            <div class="text-body text-center">
                <p class="mb-0 font-semibold text-x" style="color: #01c0c8;">© <?= date('Y') ?> <a href="#" target="_blank">Yusron Wirawanto</a>. All rights reserved.</p>
            </div>
        </div>
    </div>
</footer>
...
<button
    class="text-white p-3 rounded-circle d-flex align-items-center justify-content-center customizer-btn" style="background-color: #01c0c8;"
    type="button"
    data-bs-toggle="offcanvas"
    data-bs-target="#offcanvasExample"
    aria-controls="offcanvasExample">
    <i class="icon ti ti-settings fs-7 rotate-icon"></i>
</button>
