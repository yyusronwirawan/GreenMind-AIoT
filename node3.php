...
<script>
  function sendData(switchId, value) {
    fetch('backend/node3/update_switch3.php', {
        method: 'POST',
        headers: {
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('backend/node3/load_switch3.php')
      .then(response => {
        if (!response.ok) {
...
<script src="./backend/node3/data3.js"></script>
<script src="./backend/node3/grafik3.js"></script>
